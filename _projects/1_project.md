...
| **Dimension**               | **English Name** | **State Form** | **Typical Examples**             | **Explanation (English)**                                                                                                   | **Python Example**                                                                                                                                                                                                                                                                                                                                                                                                                     |
| --------------------------- | ---------------- | -------------- | -------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **0D (Constant DP)**        | Constant DP      | `dp = x`       | Fibonacci (rolling optimization) | Only depends on a few previous states, so no array is needed.                                                               | `python\n# Constant (0D) DP – Fibonacci using rolling variables\ndef fib(n):\n    if n <= 1:\n        return n\n    a, b = 0, 1  # only keep last two states\n    for _ in range(2, n + 1):\n        a, b = b, a + b\n    return b\n`                                                                                                                                                                                                  |
| **1D (One-Dimensional DP)** | 1D DP            | `dp[i]`        | Climbing Stairs, LIS             | Current state depends only on previous one or several one-dimensional states.                                               | `python\n# 1D DP – Climbing Stairs\ndef climbStairs(n):\n    dp = [0] * (n + 1)\n    dp[0], dp[1] = 1, 1\n    for i in range(2, n + 1):\n        dp[i] = dp[i - 1] + dp[i - 2]\n    return dp[n]\n`                                                                                                                                                                                                                                    |
| **2D (Two-Dimensional DP)** | 2D DP            | `dp[i][j]`     | LCS, Edit Distance               | Used for grid or two-sequence problems. Each state usually depends on **top**, **left**, and **top-left (diagonal)** cells. | `python\n# 2D DP – Longest Common Subsequence (LCS)\ndef lcs(text1, text2):\n    m, n = len(text1), len(text2)\n    dp = [[0] * (n + 1) for _ in range(m + 1)]\n    for i in range(1, m + 1):\n        for j in range(1, n + 1):\n            if text1[i - 1] == text2[j - 1]:\n                dp[i][j] = dp[i - 1][j - 1] + 1\n            else:\n                dp[i][j] = max(dp[i - 1][j], dp[i][j - 1])\n    return dp[m][n]\n` |
