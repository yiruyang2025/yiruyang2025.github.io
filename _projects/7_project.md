...
| **Continuous music tokenization**               | **This work: continuous-token music generation with Flow-Matching DiT / xiT**                                     |        **2026** | Yiru Yang et al.                                                                                                                                                                                                    | **Continuous perceptual / symbolic / latent music tokens**           | Treats music as continuous perceptual trajectories rather than hard discrete token IDs, aiming to preserve pitch, rhythm, timbre, motif, phrase, and form structure for controllable Mozart-style generation.                                                                                         | Continuous music tokens, Flow-Matching DiT / xiT, perceptual audio latent trajectories                           |
