...
| **Transformers in 3D/4D Segmentation** | **DINOv3** (Meta, 2024, open-vocab semantic features), **VGGT** (CVPR’25, geometry + segmentation backbone), **PanSt3R** (CVPR’25, ETH, 4D panoptic segmentation), **MonST3R** (CVPR’25, Meta+ETH, motion-aware segmentation), **Shape of Motion** (CVPR’25, Meta Reality Labs) |
