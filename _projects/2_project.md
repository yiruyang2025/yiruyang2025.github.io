...
| **2024** | *DiffusionLight: Diffusion Models for Global Illumination*                          | Zexiang Xu, Ling-Qi Yan, et al.                                                                | Rendering, light transport, diffusion | Partially                                                 | Related to 3D rendering/geometry but not video features.                                        |
| **2023** | *Neuralangelo: High-Fidelity Neural Surface Reconstruction*                         | Zhaoshuo Li, Ruoxi Shi, et al.                                                                 | Neural 3D reconstruction              | **Yes**                                                   | State-of-the-art surface reconstruction with NeRF; strong geometry relevance.                   |
| **2022** | *MDETR: Modulated Detection for End-to-End Multi-Modal Understanding*               | Ishita Dasgupta, A. Kamath, et al.                                                             | Vision-language detection             | No                                                        | Multi-modal reasoning, not directly geometry.                                                   |
| **2021** | *Learning to Optimize for Image Matching*                                           | Xufeng Han, Kyle Genova, et al.                                                                | Image matching, optimization learning | **Yes**                                                   | Core to geometry feature extraction; relevant to backbone/feature field training.               |
| **2020** | *Learning Implicit Functions for 3D Shapes*                                         | Lars Mescheder, Michael Niemeyer, et al.                                                       | Implicit 3D shape modeling            | **Yes**                                                   | Pioneering implicit 3D representation.                                                          |
| **2019** | *A Theory of Fermat Paths for Non-Line-of-Sight Shape Reconstruction*               | S. Xin, S. Nousias, K. Kutulakos, A. Sankaranarayanan, S. Narasimhan, I. Gkioulekas            | Non-line-of-sight geometry            | **Yes**                                                   | Novel geometric approach to NLOS reconstruction.                                                |
| **2018** | *Taskonomy: Disentangling Task Transfer Learning*                                   | A. Zamir, A. Sax, W. Shen, L. Guibas, J. Malik, S. Savarese                                    | Transfer learning, task transfer      | Partially                                                 | Not 3D specific but relevant to multi-task backbone ideas.                                      |
| **2017** | *Densely Connected Convolutional Networks (DenseNet)*                               | Gao Huang, Zhuang Liu, Laurens van der Maaten, Kilian Weinberger                               | CNN backbone design                   | Weak                                                      | Pure 2D backbone, but foundational for deep architectures.                                      |
| **2016** | *Deep Residual Learning for Image Recognition (ResNet)*                             | Kaiming He, Xiangyu Zhang, Shaoqing Ren, Jian Sun                                              | CNN backbone design                   | Weak                                                      | Introduced residual connections; critical backbone concept but not 3D/video-specific.           |
| **2015** | *DynamicFusion: Reconstruction and Tracking of Non-rigid Scenes in Real-Time*       | Richard Newcombe, Dieter Fox, Steve Seitz                                                      | Real-time non-rigid reconstruction    | **Yes**                                                   | Landmark for 3D dynamic geometry + tracking.                                                    |
| **2014** | *Large-Scale Video Classification with Convolutional Neural Networks*               | A. Karpathy, G. Toderici, et al.                                                               | Video classification, CNNs            | Partially                                                 | Important for video features but not geometry.                                                  |
| **2013** | *3D ShapeNets: A Deep Representation for Volumetric Shapes*                         | Zhirong Wu, Song-Chun Zhu, et al.                                                              | 3D volumetric deep learning           | **Yes**                                                   | Early deep learning method for 3D representation.                                               |
| **2012** | *Pictorial Structures Revisited: Efficient Methods for Articulated Pose Estimation* | Leonid Sigal, et al.                                                                           | Human pose estimation                 | Partially                                                 | Pose estimation involves geometry but not 3D scene reconstruction.                              |
| **2011** | *Tracking-Learning-Detection (TLD)*                                                 | Zdenek Kalal, Jiri Matas                                                                       | Tracking framework                    | Partially                                                 | Video tracking backbone; weak relation to geometry.                                             |
| **2010** | *Analyzing Appearance and Shape in Video*                                           | Jianbo Shi, Deva Ramanan, et al.                                                               | Shape and motion in video             | **Yes**                                                   | Relevant to spatio-temporal feature extraction.                                                 |
| **2009** | *Robust Image Alignment via Sparse and Low-Rank Decomposition*                      | John Wright, Yi Ma, et al.                                                                     | Optimization, robust PCA              | Weak                                                      | Useful for feature alignment, not 3D.                                                           |
| **2008** | *Global Stereo Reconstruction under Second Order Smoothness Priors*                 | Oliver Woodford, Ian Reid, Philip Torr, Andrew Fitzgibbon                                      | Stereo, depth reconstruction          | **Yes**                                                   | Classical stereo + geometry optimization.                                                       |
| **2007** | *Bundle Adjustment Revisited*                                                       | Noah Snavely, Steve Seitz, Richard Szeliski                                                    | SfM optimization                      | **Yes**                                                   | Directly tied to SfM/geometry.                                                                  |
| **2006** | *Graph Cuts for Energy Minimization*                                                | Vladimir Kolmogorov, Ramin Zabih                                                               | Energy minimization methods           | Partially                                                 | Geometry-related optimization, used in stereo/segmentation.                                     |
| **2005** | *Randomized Trees for Real-Time Object Detection*                                   | Pierre Viola, Michael Jones, et al.                                                            | Object detection, random forests      | No                                                        | More detection/backbone related, not 3D.                                                        |
