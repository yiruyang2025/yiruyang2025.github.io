...
- (Rust, OCaml), C++, Python, GPGPU, CUDA, Jax, PyTorch, Blender, MuJoCo, Unreal, Ray, SUMO, NPU, FPGA, Deeploy, PULP, (ASIC), Linux, ROS2
...
- 📍 [Important Thesis](https://yiruyang2025.github.io/projects/5_project/) - `Learning ODE (to PDE / MHD)` from Observed Dynamics, [M-Layer](https://arxiv.org/pdf/2008.03936), [AI Lab](https://las.inf.ethz.ch/teaching)
