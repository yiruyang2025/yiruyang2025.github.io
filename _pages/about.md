...
- (OCaml), Rust, `Jax`, TPU, C++, TensorFlow, Python, GPGPU, CUDA, PyTorch, Blender, MuJoCo, Unreal, Ray, SUMO, NPU, FPGA, Deeploy, PULP, (ASIC), Linux, ROS2
...
- 📍 [Important Thesis](https://yiruyang2025.github.io/projects/5_project/) - When MLP Fails near the Singularity, M-Layer Learning `Dynamics algebraic constraints from Galaxies to a Cell`, [General Relativity Law Verification](https://arxiv.org/pdf/2008.03936), [ML Lab](https://las.inf.ethz.ch/people), [Science Lab](https://scholar.google.com/citations?user=J-JXXQYAAAAJ&hl=en), Is Planet 10 / Cell X Real?
