...
- 📍 Skill Set - **(`4d Vision Feature Extractor`) / Multimodal / Biosignal modeling / `End-to-End Encrypted DevOps Collaboration Stack`**
...
- 📍 [Project and Master Thesis](https://yiruyang2025.github.io/projects/2_project/) - `Segment Everything - with Human Surgeon Experts in the loop` / instance segmentation head, Diffusion, if u don't even have specific tasks, how come making a model better
